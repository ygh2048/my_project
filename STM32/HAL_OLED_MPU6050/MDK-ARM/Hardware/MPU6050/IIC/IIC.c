...
void IIC_Init(void)
{					     
	GPIO_InitTypeDef GPIO_InitStruct_MPU6050 = {0};
	__HAL_RCC_GPIOB_CLK_ENABLE();
	GPIO_InitStruct_MPU6050.Pin = GPIO_PIN_6|GPIO_PIN_7;
	GPIO_InitStruct_MPU6050.Mode = GPIO_MODE_OUTPUT_OD;
	GPIO_InitStruct_MPU6050.Pull = GPIO_NOPULL;
	GPIO_InitStruct_MPU6050.Speed = GPIO_SPEED_FREQ_HIGH;
	
	HAL_GPIO_Init(GPIOB, &GPIO_InitStruct_MPU6050);
}
//产生IIC起始信号
