...
void draw_ins_wave(void)
{
	...
	for(uint16_t i=127;i>0;i--)
	{
		...
		Draw_Wave_Buf[0][0]=NamelessQuad.Speed[_UP];
		Draw_Wave_Buf[1][0]=NamelessQuad.Acceleration[_UP];	
...
//	
//	x1=63+32*constrain_float(NamelessQuad.Position[_EAST]/Map_Scale,-1.0f,1.0f);
//	y1=31+32*constrain_float(NamelessQuad.Position[_NORTH]/Map_Scale,-1.0f,1.0f);
