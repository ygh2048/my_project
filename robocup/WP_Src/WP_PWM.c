...
void PWM_Init(void)
{
  ...
  PWM_Output(1000,1000,1000,1000);
	//预留PWM
	PWMPulseWidthSet(PWM0_BASE,PWM_OUT_1,1.25*1500);//PB7——M0P1 
	PWMPulseWidthSet(PWM0_BASE,PWM_OUT_0,1.25*1500);//PB6——M0P0
}
...
void PWM_Init(void)
{
  ...
  PWM_Output(1000,1000,1000,1000);
	//预留PWM
	PWMPulseWidthSet(PWM0_BASE,PWM_OUT_2,1.25*1500);//PB4——M0PWM2
	PWMPulseWidthSet(PWM0_BASE,PWM_OUT_3,1.25*1500);//PB5——M0PWM3
}
